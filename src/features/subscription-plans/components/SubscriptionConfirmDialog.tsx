...
export const SubscriptionConfirmDialog: React.FC<SubscriptionConfirmDialogProps> = ({
  ...
  const currentBillingCycle = selectedPricing?.billingCycle || (plan.billingCycle as BillingCycle);
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {!hasPricings && <BillingCycleBadge billingCycle={plan.billingCycle as BillingCycle} />}
          </div>
          ...
          {plan.features && plan.features.length > 0 && (
            <div>
              <h3 className="text-sm font-semibold mb-3">包含功能</h3>
