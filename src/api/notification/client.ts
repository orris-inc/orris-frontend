 ...
 * Updated 2026-01-29: Changed id parameter from number to string (SID format: ann_xxx)
 * Updated 2026-01-30: Removed sendNotification option (announcements decoupled from notifications)
 */
 ...
 * Added 2026-01-30: Returns count of announcements published after user's last read time
 */
export async function getAnnouncementUnreadCount(): Promise<UnreadCountResponse> {
 ...
 * Added 2026-01-30: Marks individual announcement as read (separate from markAnnouncementsAsRead)
 */
export async function markAnnouncementAsRead(id: string): Promise<void> {
  await apiClient.post<APIResponse<null>>(`/announcements/${id}/read`);
}
