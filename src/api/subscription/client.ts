 ...
 *
 * Recent changes:
 * - 2026-01-30: Updated getPublicPlans documentation with detailed JSDoc
 * - 2026-01-29: Updated to reflect removal of apiRateLimit, maxUsers, maxProjects fields
...
/**
 * Get public subscription plans available for purchase
 *
 * Retrieves all subscription plans that are marked as public and currently active.
 * This endpoint is publicly accessible without authentication, suitable for
 * displaying available plans on pricing pages or plan selection interfaces.
 *
 * @route GET /plans/public
 * @public No authentication required
 * @returns Array of subscription plans with their pricing options, sorted by sortOrder
 *
 * @remarks
 * - Only returns plans with `status: 'active'` and `isPublic: true`
 * - Each plan includes its available pricing options (different billing cycles)
 */
